/**
 * Created by aillenaromin on 6/20/16.
 */
public class HwClass {
        ...
        public static void main(String[] args) {
            ...
            /* the result will be 3 because even though there is an remainder,
             the int data type will round it to the nearest whole number */
        }
